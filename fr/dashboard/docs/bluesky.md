Reacting with a _light blue 🩵_-emoji to a message containing a Bluesky post for the first time will send you an authorization link via DMs. You don't have to create an app password or anything, just simply authorize Wamellow with your Bluesky account. <br /> <br />
...
To like a post, you must react with either the light blue heart (🩵) or the blue heart (💙) emoji. <br/> <br/>
...
Wamellow is compatible with any PDS, including Bluesky mushroom, Spark PDS, or your own self-hosted server. <br /> <br />
...
**Note:** Re-authorizing the connection will typically resolve any problems. If you are unfamiliar with what a PDS is, you can disregard this section. <br/> <br/>
